                  ...
                  <div className="pt-4 flex flex-col gap-[10px]">
                    <div className="">
                      ...
                      <p className="font-quicksand font-normal text-[10px] text-gray-300 w-[253px]">
                        Design an intuitive, visually appealing storefront that
                        showcases products effectively and offers seamless
                        navigation for a smooth shopping experience.
                      </p>
                    </div>
                    <div className="">
                      <p className="font-bold text-[16px] uppercase flex items-center gap-[6px] text-white">
                      ...
                      <p className="font-quicksand font-normal text-[10px] text-gray-300 w-[253px]">
                        ...
                        like credit/debit cards, digital wallets, UPI, and BNPL
                        (Buy Now, Pay Later) solutions, supported by encryption
                        for data safety.
                      </p>
                    </div>
                  ...
                  <div className="pt-4 flex flex-col gap-[10px]">
                    <div className="">
                      ...
                      <p className="font-quicksand font-normal text-[10px] text-gray-300 w-[253px]">
                        ...
                        their accounts, view transactions, and track activities
                        seamlessly.
                      </p>
                    </div>
                    <div className="">
